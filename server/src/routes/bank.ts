...
/**
 * 获取仓库物品
 * GET /api/v1/bank/:characterId
 */
async function getBankItems(fastify: FastifyInstance, request: any, reply: any) {
  try {
 ...
 */
async function depositItem(fastify: FastifyInstance, request: any, reply: any) {
  try {
 ...
 */
async function withdrawItem(fastify: FastifyInstance, request: any, reply: any) {
  try {
    const { characterId, itemId, quantity } = request.body
...
export async function bankRoutes(fastify: FastifyInstance) {
  fastify.get('/bank/:characterId', getBankItems)
  fastify.post('/bank/deposit', depositItem)
  fastify.post('/bank/withdraw', withdrawItem)
}
